...
const Contacto = () => {
  return (
    <div className='w-full py-[6rem] px-4'>
        <div className='max-w-[1240px] shadow-lg shadow-blue-500/50 bg-[#1b1464] mx-auto flex flex-col py-8 px-4 md:mx-14 lg:rounded-[2rem] rounded-lg justify-center items-center text-white'>
            ...
            <div className='flex shadow-lg shadow-blue-500/50 bg-white hover:scale-105 duration-300 hover:bg-gray rounded-[2rem] my-8 m-4 px-6 py-2 text-[#1b1464]'>
